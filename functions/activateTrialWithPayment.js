...
exports.handler = async (event) => {
  ...
  try {
    ...
    // Check for existing device hash linked to a purchase
    const existingDeviceRecord = await DeviceHash.findOne({ device_hash: deviceHash });
    ...
    trialExpiry.setDate(trialExpiry.getDate() + 3); // Change this number to adjust trial length  
